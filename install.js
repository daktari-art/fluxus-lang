...
class FluxusInstaller {
    ...
    findGlobalInstallDir() {
        ...
        for (const dir of possibleDirs) {
            if (fs.existsSync(dir)) {
                try {
                    ...
                    console.log(`📁 Using writable installation directory: ${dir}`);
                    return dir;
                } catch (e) {
        ...
        console.log('⚠️  No writable global directory found. Proceeding with local installation.');
    ...
    installGlobal() {
        ...
        if (this.installDir === this.projectRoot) {
            console.log('❌ Global installation skipped: No writable global directory found.');
